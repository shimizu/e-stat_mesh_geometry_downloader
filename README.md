...
```powershell
mkdir bin -Force
Invoke-WebRequest -Uri "https://github.com/duckdb/duckdb/releases/download/v1.3.2/duckdb_cli-windows-amd64.zip" -OutFile duckdb.zip
...
curl -L -o duckdb.zip "https://github.com/duckdb/duckdb/releases/download/v1.3.2/duckdb_cli-osx-universal.zip"
...
curl -L -o duckdb.zip "https://github.com/duckdb/duckdb/releases/download/v1.3.2/duckdb_cli-linux-amd64.zip"
unzip -o duckdb.zip -d bin && rm duckdb.zip
chmod +x bin/duckdb
./bin/duckdb -c "INSTALL spatial; LOAD spatial; SELECT 'ok';"
```
